...
- **WHEN** no custom keybindings are configured and the user presses `C` in the article view
- **THEN** the article text is copied to the clipboard, and lowercase `c` continues to copy the article URL
